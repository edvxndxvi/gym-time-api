...
public class Account {
    ...
    @NotNull
    @Size(min = 5, max = 12, message = "O usuário deve ter no mínimo 5 caracteres e no máximo 12.")
    @Pattern(regexp = "^[a-zA-Z0-9_]+$", message = "Use apenas letras, números e underline.")
    private String username;

    @NotNull
    @Size(min = 2, max = 15, message = "O usuário deve ter no mínimo 2 caracteres e no máximo 15.")
    private String name;
